...
d3.json(geoData).then(function(data){
  ...
  geojson = L.choropleth(data, {
    ...
    onEachFeature: function(feature, layer) {
      layer.bindPopup("" + feature.properties.NAME + "<br /><br />Estimated employed population with children age 6-17" +
      feature.properties.DP03_16 + "<br /><br />Estimated Total Income and Benefits for families: $" + feature.properties.DP03_75E)
    }
  }).addTo(myMap);
